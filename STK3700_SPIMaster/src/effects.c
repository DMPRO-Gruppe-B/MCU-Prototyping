...
void setup_effects() {
	...
	bitcrusher.settings[0] = create_setting(0b00000000, "Enable", "", 0, 1, 0,
			1);
	bitcrusher.settings[1] = create_setting(0b00000001, "Bits", "bits", 0, 1, 0,
			8);
	bitcrusher.settings[2] = create_setting(0b00000010, "Sample interval", "",
			1, 1, 1, 16);

	effect_t delay = create_effect("Delay", 2);
	delay.settings[0] = create_setting(0b00000100, "Enable", "", 0, 1, 0, 1);
	delay.settings[1] = create_setting(0b00000101, "Delay", "ms", 0, 50, 0,
			500);
